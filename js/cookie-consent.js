/* agrododia.com.br — cookie consent banner + Google Consent Mode v2 (GDPR/LGPD)
 * Standalone, no dependencies. Stores choice in localStorage as 'ad-consent' = 'granted' | 'denied'.
 */
(function () {
  'use strict';
  var KEY = 'ad-consent';
  ...
  function init() {
    ...
    banner.addEventListener('click', function (e) {
      ...
      document.dispatchEvent(new CustomEvent('ad:consent', { detail: { value: action } }));
    });
  }
